...
export type EmailCanvasDevice = "DESKTOP" | "MOBILE";

const DEVICE_WIDTHS: Record<EmailCanvasDevice, number | null> = {
  DESKTOP: null,
  MOBILE: 390,
};
...
interface EmailCanvasProps {
  html: string;
  device: EmailCanvasDevice;
  isLoading: boolean;
  onSelect: (id: string) => void;
  onMove: (id: string, targetId: string, position: "before" | "after") => void;
}

export function EmailCanvas({ html, device, isLoading, onSelect, onMove }: EmailCanvasProps) {
