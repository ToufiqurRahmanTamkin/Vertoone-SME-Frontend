    ...
    items: [
      {
        ...
        path: "/crm/business-tools/email-templates",
        icon: "Mail",
        section: null,
        roles: COMPANY,
        description: "Reusable email bodies you send from campaigns and deals.",
      },
      {
        title: "SMS templates",
        path: "/crm/business-tools/sms-templates",
        icon: "PhoneCall",
        section: null,
        roles: COMPANY,
        description: "Short message bodies for reminders and follow-ups.",
      },
      {
        title: "Web forms",
        path: "/crm/business-tools/forms",
        icon: "ClipboardList",
        section: null,
        roles: COMPANY,
      ...
      {
        title: "QR & short links",
        path: "/crm/business-tools/links",
        icon: "Plug",
        section: null,
        roles: COMPANY,
        description: "Trackable links and codes that feed campaign reporting.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        path: "/crm/my-social/accounts",
        icon: "Network",
        section: null,
        roles: COMPANY,
        description: "Social profiles linked to this workspace.",
      },
      {
        title: "Posts",
        path: "/crm/my-social/posts",
        icon: "Megaphone",
        section: null,
        roles: COMPANY,
        description: "What you have published, and how it performed.",
      },
      {
        title: "Scheduler",
        path: "/crm/my-social/scheduler",
        icon: "CalendarClock",
        section: null,
        roles: COMPANY,
        description: "Posts queued to go out later.",
      },
      {
        title: "Inbox",
        path: "/crm/my-social/inbox",
        icon: "Mail",
        section: null,
        roles: COMPANY,
        description: "Comments and messages arriving from your social accounts.",
      },
    ],
  },
  {
