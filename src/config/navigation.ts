...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    items: [
      {
        title: "General",
        path: "/sme/configuration/general",
        icon: "Settings",
        section: null,
        roles: COMPANY,
        description: "Currency, timezone, numbering and the stock rules everything else inherits.",
      },
      {
      ...
      },
      {
        ...
        path: "/sme/configuration/finance",
        icon: "Calculator",
        section: null,
        roles: COMPANY,
        description: "QuickBooks and other accounting links, sync rules and account mapping.",
      },
      {
        title: "Tax Configuration",
        path: "/sme/configuration/tax",
        icon: "Percent",
        section: null,
        roles: COMPANY,
        description: "Registration details, default rates and how tax is applied to a line.",
      },
      {
        title: "Invoice & Documents",
        path: "/sme/configuration/invoice",
        icon: "Receipt",
        section: null,
        roles: COMPANY,
        description: "Document numbering, payment terms and how printed paperwork looks.",
      },
      {
        title: "Notifications",
        path: "/sme/configuration/notifications",
        icon: "Bell",
        section: null,
        roles: COMPANY,
        description: "SMS and WhatsApp providers, and which events reach whom.",
      },
      {
        title: "Integrations & API",
        path: "/sme/configuration/integrations",
        icon: "Plug",
        section: null,
        roles: COMPANY,
        description: "API access, webhooks, file storage and analytics keys.",
      },
    ],
  },
