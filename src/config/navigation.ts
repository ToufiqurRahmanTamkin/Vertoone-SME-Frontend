        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                slug: "push",
                icon: "Bell",
                description: "App and browser pushes sent to your audience.",
              },
              {
                title: "Journeys",
                slug: "journeys",
                icon: "Workflow",
                description: "Multi-step nurture flows that run across every channel.",
              },
              {
                title: "Audiences & Lists",
                slug: "audiences",
                icon: "Users",
                description: "The saved segments your campaigns are sent to.",
              },
              {
                title: "A/B Tests",
                slug: "ab-tests",
                icon: "GitBranch",
                description: "Competing versions of a message and which one won.",
              },
            ],
          },
          {
        ...
        items: [
          {
            ...
            slug: "support",
            icon: "Ticket",
            description: "Customer problems and how quickly you solve them.",
            items: [
              overview("Open tickets, breached targets and how fast you reply."),
              {
                title: "Tickets",
                slug: "tickets",
                icon: "Ticket",
                description: "Every customer issue raised, owned and resolved.",
              },
              {
                title: "SLA Policies",
                slug: "sla-policies",
                icon: "Clock",
                description: "How fast you promise to respond and to resolve.",
              },
              {
                title: "Escalations",
                slug: "escalations",
                icon: "TrendingUp",
                description: "Tickets pushed up the chain and why they got there.",
              },
              {
                title: "Satisfaction Surveys",
                slug: "csat",
                icon: "Award",
                description: "What customers said after their issue was closed.",
              },
            ],
          },
          {
            ...
            slug: "knowledge",
            icon: "BookOpen",
            description: "Answers customers can find without asking you.",
            items: [
              overview("Article views, search gaps and what goes unanswered."),
              {
                title: "Articles",
                slug: "articles",
                icon: "BookOpen",
                description: "Help articles published to your customers.",
              },
              {
                title: "Categories",
                slug: "categories",
                icon: "Tags",
                description: "How your knowledge base is organised for browsing.",
              },
              {
                title: "Customer Portal",
                slug: "customer-portal",
                icon: "Globe",
                description: "The signed-in area where customers track their own tickets.",
              },
            ],
          },
        ],
        ...
        items: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                icon: "Activity",
                roles: COMPANY,
                description: "Who changed what inside your company, and when.",
              },
              {
                title: "API & Webhooks",
